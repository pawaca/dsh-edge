...
Verify the live base and exact head, inspect the complete diff, and read [`AGENTS.md`](../../../AGENTS.md). Prioritize correctness, security, persistent data, release artifacts, and required user behavior over style.
...
3. Durable Object bindings, class names, SQL/KV/VFS data, session events, auth cookies, and routes remain compatible.

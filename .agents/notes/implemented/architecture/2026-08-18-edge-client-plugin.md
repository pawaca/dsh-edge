...
Repository-structure details in this note are superseded by the [implemented standalone wrapper architecture](2026-08-19-dsh-edge-standalone-wrapper.md). The Edge-owned client-plugin decision remains in force.

...
Repository-structure details in this note are superseded by the [implemented standalone wrapper architecture](2026-08-19-dsh-edge-standalone-wrapper.md). The installer and publication decisions remain in force.
